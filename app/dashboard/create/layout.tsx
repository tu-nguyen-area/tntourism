...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  <div>
    <div className="flex justify-center">
      <h1 className="mt-8 text-2xl md:text-5xl font-bold bg-gradient-to-r from-cyan-500 to-fuchsia-500 bg-clip-text text-transparent w-fit">Create Dashboard</h1>
    </div>
